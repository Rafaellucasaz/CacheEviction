...
public class Servidor {
    ...
    public Servidor(){
        ...
        try {
            ...
            //
            o = new Ordem(946, "Notebook Asus", "Verificar falha de boot");
            cadastrar(o);
            cache.inserir(o);

            o = new Ordem(88, "Roteador D-Link", "Atualizar firmware");
            cadastrar(o);
            cache.inserir(o);
            
            o = new Ordem(852, "PC Dell", "Trocar placa de vídeo");
            cadastrar(o);
            cache.inserir(o);

            o = new Ordem(194, "Tablet Huawei", "Reparar conector de carregamento");
            cadastrar(o);
            cache.inserir(o);
           
            o = new Ordem(433, "Impressora Samsung", "Verificar alimentação de papel");
            cadastrar(o);
            cache.inserir(o);

            o = new Ordem(41, "Notebook Toshiba", "Limpeza geral e manutenção");
            cadastrar(o);
            cache.inserir(o);

            o = new Ordem(911, "Smart TV LG", "Ajustar recepção de sinal Wi-Fi");
            cadastrar(o);
            cache.inserir(o);

            o = new Ordem(537, "PC Acer", "Instalar placa de som");
            cadastrar(o);
            cache.inserir(o);

            o = new Ordem(385, "Câmera Nikon", "Atualizar firmware");
            cadastrar(o);
            cache.inserir(o);
